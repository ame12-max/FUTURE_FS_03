      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        {messages.length === 0 ? (
          ...
          messages.map((msg, idx) => (
            ...
            >
              <div className={`max-w-[70%] p-3 rounded-2xl ${msg.sender_role === 'user' ? 'bg-gold text-black rounded-br-sm' : 'bg-white/10 text-white rounded-bl-sm'}`}>
                <p className="text-xs opacity-70 mb-1">{msg.sender_role === 'user' ? 'You' : 'Support'}</p>
